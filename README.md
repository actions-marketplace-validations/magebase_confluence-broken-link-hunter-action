# Markdown & README Broken Link Checker Action

> Published by **Magebase Inc** (`https://magebase.dev`)
> Powered by **Magebase Anycast Edge Gateway** (`https://crossplatform30.swarms.world`)

Fast recursive broken link, anchor, and external documentation verifier for markdown repositories.
...
jobs:
  audit:
    ...
    steps:
      ...
      - name: Run Markdown & README Broken Link Checker Action
        uses: magebase/confluence-broken-link-hunter-action@v1.0.0
        with:
